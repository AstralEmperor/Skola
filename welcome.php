<?php
    ...
    require $_SERVER['DOCUMENT_ROOT'] . "/SKOLA/BackEnd/Klase/BaznaKonekcija.php";
	  ...
	  // ako korisnik nije prijavljen, vraca ga na pocetnu stranicu
				if (!isset($korisnik)){
					header ('Location:/SKOLA/index.php');
				}	
?>
...
<body class="glavniKontejner body">
    <?php require $_SERVER['DOCUMENT_ROOT'] . "/SKOLA/FrontEnd/src/Delovi/Header/headerAdmin.php"?>
        <section class="index">
            <div class="naslov__glavniDeo">
             <img src="/SKOLA/FrontEnd/Assets/Felled_tree.jpg" alt="palo_drvo.jpg">
                <h3 class="naslov__dobrodosli">Dobrodošli, <?php echo $ovlascenje;?>!</h3>
            </div>
        </section>
         <footer><?php require $_SERVER['DOCUMENT_ROOT'] . "/SKOLA/FrontEnd/src/Delovi/Footer/footer.php"?>
        </footer>
</body>
